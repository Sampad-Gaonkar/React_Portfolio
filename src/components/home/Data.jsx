...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Sampad Gaonkar
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description"> I'm a Creative web designer based in India, and I'm very passionate and dedicated to my work.</p>
