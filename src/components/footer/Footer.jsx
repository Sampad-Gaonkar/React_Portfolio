  ...
  return (
    <footer className="footer">
        <div className="footer__container container">
            <h1 className="footer__title">Sampad Gaonkar</h1>
            ...
            <div className="footer__social">
                ...
                <a href="https://www.twitter.com/" className="footer__social-link" target='_blank'><i className="bx bxl-twitter"></i></a>
            </div>
            
            <span className="footer__copy">&#169; SampadGaonkar. All rights reserved</span>
        </div>
    </footer>
  )
}
